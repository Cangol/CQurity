...
import com.azhuoinfo.cqurity.api.ApiContants;
...
import com.azhuoinfo.cqurity.model.UserAuth;
import com.azhuoinfo.cqurity.utils.Constants;
import com.azhuoinfo.cqurity.view.CommonDialog;
import com.azhuoinfo.cqurity.view.CommonDialog.OnButtonClickListener;
...
public class AccountVerify {
	...
	public void showLoginDialog(final BaseFragment fragment) {
		...
		mLoginDialog.setTitle(com.azhuoinfo.cqurity.R.string.dialog_expire_title)
		.setMessage(com.azhuoinfo.cqurity.R.string.dialog_expire_content)
		.setLeftButtonInfo(fragment.getString(com.azhuoinfo.cqurity.R.string.common_dialog_confirm), new OnButtonClickListener() {
		...
		}).setRightButtonInfo(fragment.getString(com.azhuoinfo.cqurity.R.string.common_dialog_cancel), new OnButtonClickListener() {
			@Override
			public void onClick(View view) {
				// do nothing
			}
